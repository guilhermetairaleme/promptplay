                ...
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="flex h-16 justify-between">
                        <div class="flex items-center space-x-4">
                            <!-- Subdomínio estilizado -->
                            <div v-if="subdomain" class="hidden sm:block neon-subdomain">
                                {{ subdomain }}
                            </div>
...
.neon-subdomain {
    ...
    box-shadow: 0 0 10px rgba(59, 130, 246, 0.6), 0 0 20px rgba(147, 51, 234, 0.6);
...
@keyframes neonGlow {
    0% {
        box-shadow: 0 0 8px rgba(59, 130, 246, 0.5), 0 0 15px rgba(147, 51, 234, 0.5);
    }
    100% {
        box-shadow: 0 0 14px rgba(59, 130, 246, 0.8), 0 0 25px rgba(147, 51, 234, 0.8);
    }
}
</style>
